...
(function () {
    ...
    class AudioEngine {
        ...
        playCrash() {
            ...
            const b = this.ctx.createBuffer(1, this.ctx.sampleRate * ENGINE_CONFIG.AUDIO.CRASH.DURATION, this.ctx.sampleRate);
    ...
    class ParticleSystem {
        ...
        update(dt) {
            for (let i = this.particles.length - 1; i >= 0; i--) {
                ...
                p.x += p.vx; p.y += p.vy; p.life -= dt * ENGINE_CONFIG.PARTICLES.DECAY_RATE;
